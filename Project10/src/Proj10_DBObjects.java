 ...
 * Add Record Class for project 10
 */
...
public class Proj10_DBObjects {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		while (scan.hasNextLine()) {
			...
			// store correct data to Record object
			records[correctCount] = new Record(eachLine.substring(0, spaceIndex[0]),
					eachLine.substring(spaceIndex[0] + 1, spaceIndex[1]),
					Integer.parseInt(eachLine.substring(spaceIndex[1] + 1)));
		...
		// resize all of data
		Record[] newRecords = resizeArray(records, correctCount);
		...
		while (in.hasNextLine()) {
			...
			if (methodName.equals("lastName")) {
				...
				findByLastName(newRecords, keyWords);
				continue;
			}
			...
			if (methodName.equals("firstName")) {
				...
				findByFirstName(newRecords, keyWords);
				continue;
			}
	...
	public static void listAll(Record[] records) {
	...
	public static void findByLastName(Record[] records, String lastName) {
	...
	public static void findByFirstName(Record[] records, String firstName) {
		...
		// find firstName
		for (int i = 0; i < records.length; i++) {
			if (records[i].getFirstName().equals(firstName)) {
				index[count] = i;
				count++;
			}
		}
	...
	public static void findByAge(Record[] records, int age) {
		int[] index = new int[MAX];
	...
	// resize Record array
	public static Record[] resizeArray(Record array[], int lastIndex) {

		Record[] newArray = new Record[lastIndex];
